<div class="p-2 pb-3">
    <div class="product-wap card rounded-0">
        <div class="card rounded-0">
            <img class="card-img rounded-0 img-fluid" src="<?php echo htmlspecialchars($row['p_image']); ?>">
            <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                <ul class="list-unstyled">
                    ...
                    <form action="./data/manage_cart.php" method="POST">
                        ...
                        <input type="hidden" name="product-image" value="<?php echo htmlspecialchars($row['p_image']); ?>">
