...
// document.getElementById('unit-<?php echo $row['p_id']; ?>')
//      .addEventListener('keyup', function() {
//      let unitText = parseFloat(document.getElementById('unit-<?php echo $row['p_id']; ?>').value.trim());
//      let priceText =  parseFloat(document.getElementById('price-<?php echo $row['p_id']; ?>').innerText);
//      let newValue = unitText * priceText;
//      alert(newValue);
//      });
